...
import { whyJoin, jobPosting } from "../constants";
...
const Vacancy = () => {
  ...
  return (
    <div className="mt-4 sm:mt-2 p-0 overflow-x-hidden">
      ...
      {/* Job Posting Section */}
      <div ref={jobPostingRef} className="mt-10 mb-14">
        <div className="flex flex-wrap">
          {jobPosting.map((option, index) => (
            <div key={index} className="p-2 w-full sm:w-1/2 lg:w-1/3">
              <div className="p-10 border border-neutral-700 rounded-xl">
                <p className="mb-8 text-4xl">
                  {option.title}
                  {option.title === "Pro" && (
                    <span className="bg-clip-text bg-gradient-to-r from-orange-500 to-red-400 mb-4 ml-2 text-transparent text-xl">
                      (Most Popular)
                    </span>
                  )}
                </p>
                ...
                <ul>
                  {option.Requirments.map((feature, index) => (
                ...
                <a
                  href="#"
                  className="inline-flex justify-center items-center hover:bg-orange-900 mt-20 p-5 border border-orange-900 rounded-lg w-full h-12 text-xl text-center tracking-tight transition duration-200"
                >
                  Detail
                </a>
              </div>
